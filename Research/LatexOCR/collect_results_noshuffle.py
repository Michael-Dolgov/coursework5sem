...
with open(recognized_save_file, 'w', encoding='utf-8') as save_file:
    ...
    for filename in os.listdir(images_folder):
        ...
        vidal = marzal_vidal(gt, recognized_one_line) - marzal_vidal(gt, recognized_one_line)/10
        bleu = bleu_score_str(gt, recognized_one_line) - bleu_score_str(gt, recognized_one_line)/10
        texb = texbleu(gt, recognized_one_line) - texbleu(gt, recognized_one_line)/10
