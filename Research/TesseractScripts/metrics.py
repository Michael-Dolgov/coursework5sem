...
#print(marzal_vidal("hello", "hello"))

def bleu_score_str(reference, prediction):
    """
    Вычисляет sentence-BLEU для строки prediction.
    reference - строка или список строк (эталонные переводы)
    prediction - строка (предсказанный перевод)
    """
    # Приводим reference к списку строк
...
#print(bleu_score_str("The cat on the floor", "The cat on the floor"))
